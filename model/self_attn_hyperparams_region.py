...
def load_hyperparams():
    ...
    argparser.add_argument('--blank_num', type=int, default=10)
    argparser.add_argument('--batch_size', type=int, default=50)
    argparser.add_argument('--test_batch_size', type=int, default=50)
    ...
    argparser.add_argument('--rmse', type=int, default=0)
    ...
    argparser.add_argument('--if_max', type=int, default=1)
    ...
    argparser.add_argument('--log_disk_dir', type=str, default='../log/')
    ...
    #argparser.add_argument('--data_dir', type=str, default='/data/')
    argparser.add_argument('--extra_data_dir', type=str, default='../data/') # add a path for region distance
    ...
    argparser.add_argument('--analyse_data_save_dir', type=str, default= "../log/analyse_data/")
